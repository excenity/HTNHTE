...
#' @param incremental  Only regenerate new cohorts (i.e., skipp cohorts that were previously generated and are unchanged)
#' @param incrementalFolder  Location to save a file that tracks what cohorts have been generated previously for incremental
#'
#' @return
#' The cohorts are generated into the specfied cohort schema and table
#'
#' @export
